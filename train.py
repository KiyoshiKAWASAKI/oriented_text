...
tf.app.flags.DEFINE_float(
	'alpha1', 1., 'Alpha parameter in the loss function.')
tf.app.flags.DEFINE_float(
	'alpha2', 1., 'Alpha parameter in the loss function.')
tf.app.flags.DEFINE_float(
...
tf.app.flags.DEFINE_string(
	'model_name', 'text_box_512', 'The name of the architecture to train.')
tf.app.flags.DEFINE_string(
	...
	with tf.Graph().as_default():
		...
		with tf.device(deploy_config.inputs_device()):
			...
			batch_queue = slim.prefetch_queue.prefetch_queue(
				tf_utils.reshape_list([b_image, b_glocalisations, b_glabels,b_glinks]),
		...
		def clone_fn(batch_queue):
			...
			# Add loss function.
			net.losses(logits, localisations, linkslogits,
							   b_glocalisations, b_glabels, b_glinks,
